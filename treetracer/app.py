...
def main():
    ...
    try:
        ...
        print("DEBUG: app.run() called. (This line might not print immediately if server blocks)") # Add this for debugging

    except Exception as e:
        print(f"ERROR: An unexpected error occurred: {e}", file=sys.stderr)
        import traceback
        traceback.print_exc(file=sys.stderr) # Prints the full traceback
    print("DEBUG: main() function finished.") # This line will likely not be reached until server stops
    return 0
